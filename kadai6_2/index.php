<?php
    ...
    if ($_SESSION["download_result"]) {
        if ($_SESSION["download_result"] == true) {
            $blue_success_text = "ファイルは正常に生成されました";
        } else {
            $red_error_text = "CSVの生成中にエラーが発生しました";
        }
        $_SESSION["download_result"] = null;
    }
...
<html lang="ja">
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            //     var array = [];
            //     var checkboxes = document.querySelectorAll('input[class=downloadcheckbox][type=checkbox]:checked')
